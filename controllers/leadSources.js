...
exports.edit = function(request, response) {
  ...
  LeadSource.findOne({_id: leadSourceId}).then(function(foundLeadSource) {
    return response.render('editLeadSource', {
      ...
      leadSourceFacebookid: foundLeadSource.facebookid,
      leadSourceRoiqid: foundLeadSource.roiqid,
...
exports.update = function(request, response) {
  ...
  request.checkBody('forwardingNumber', 'Forwarding number cannot be empty')
    .notEmpty();
  request.checkBody('facebookid', 'empty').notEmpty();
  request.checkBody('roiqid', 'empty').notEmpty();
  ...
  LeadSource.findOne({_id: leadSourceId}).then(function(foundLeadSource) {
    ...
    foundLeadSource.facebookid = request.body.facebookid;
    foundLeadSource.roiqid = request.body.roiqid;
